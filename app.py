...
class App:
    ...
    def search(self, search_text, num_results=1):
        ...
        _, indices = self.index.search(text_features, num_results)
        results = [self.image_paths[indices[0][i]] for i in range(num_results)]
        return results
